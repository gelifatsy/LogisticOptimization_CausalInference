...
class Plotter:
    ...
    def plotly_plot_scatter(self, df, x_col, y_col, marker_size, hover=[]):
        fig = px.scatter(
                df,
                x=x_col,
                y=y_col,
    ...
    def plot_box_multi(self, df, x_col, y_col, title):
        plt.figure(figsize=(12, 7))
